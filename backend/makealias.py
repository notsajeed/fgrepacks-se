...
def generate_aliases():
    DATA_JSON = os.path.join("data", "games.json")
    DATA_WITH_ALIASES_JSON = os.path.join("data", "games_with_aliases.json")
    ...
    with open(DATA_WITH_ALIASES_JSON, "w", encoding="utf-8") as f:
        json.dump(games, f, indent=2, ensure_ascii=False)

    print(f"✅ Aliases generated for {len(games)} games.")
    return games
